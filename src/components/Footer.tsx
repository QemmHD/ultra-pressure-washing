        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/UltraPressureWashingWindowCleaning" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-[#1877F2] hover:text-white transition-all duration-300 hover:scale-110 shadow-lg">
                <FaFacebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/ultrapressurewashing?igsh=YzVkOXduY2dpaXRj" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F56040] hover:text-white transition-all duration-300 hover:scale-110 shadow-lg">
                <FaInstagram className="w-5 h-5" />
              </a>
              <a href="https://www.tiktok.com/@ultrapressurewash?_r=1&_t=ZT-96L2f95v0MI" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-black hover:text-white hover:ring-2 hover:ring-[#69C9D0] transition-all duration-300 hover:scale-110 shadow-lg">
